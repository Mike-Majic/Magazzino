...
const navItems = [
  ...
  { to: '/to-return', label: 'Materiali da riconsegnare' }, { to: '/to-return?status=riconsegnato', label: 'Materiale riconsegnato' }, { to: '/reported', label: 'Materiali denunciati' }, { to: '/movements', label: 'Movimenti' }, { to: '/setup', label: 'Setup' }
];
